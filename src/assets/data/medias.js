const medias = [
  ...
  },
  {
    ...
    medias: [
      {
        title: "Vectoriel",
        img: "../img/VectorialThumbnail.PNG",
        list: [
          "../img/Sui.png",
          "../img/Sloth.jpg",
          "../img/Chibi.png",
      ...
      },
      {
        title: "Tablette",
        img: "../img/CutHair.PNG",
        list: ["../img/CutHair.PNG", "../img/Holga.PNG"],
      },
      {
        title: "3D",
        img: "../img/Bottaro.png",
        list: ["../img/Bottaro.png", "../img/Donut.PNG"],
      },
      {
        title: "Pixel Art",
        img: "../img/img/PixelArtThumbnail.PNG",
        list: ["../img/Race.png", "../img/Dizzy.png", "../img/Artificial.png"],
      },
    ],
  },
]
